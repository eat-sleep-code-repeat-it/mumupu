...
- `hejiayi-F-Swan-lake-alternativekeys.jps` now matches through rows one and two; its remaining first difference is row-three natural-width geometry.
...
- `pnpm run verify:songs` reports 6 exact, 32 mismatched, and 0 missing caches.
